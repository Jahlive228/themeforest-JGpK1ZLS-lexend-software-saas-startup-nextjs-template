...
export default function CollectPricing() {
  const collectPricingPlans = [
    {
      title: "Starter",
  ...
  return (
    <section id="collect_pricing" className="collect-pricing-section panel overflow-hidden">
      <div className="collect-pricing-outer">
        <div className="collect-pricing-content">
          <div className="container xl:max-w-xl">
            <div className="collect-pricing-inner vstack gap-6 lg:gap-8 xl:gap-10">
              <div className="collect-pricing-header panel text-center">
                <div className="vstack gap-4">
                  <div className="collect-pricing-tagline panel">
                    <span className="badge badge-primary fs-7 fw-bold px-3 py-2 rounded-pill">
                      Tarification
                    </span>
                  </div>
                  <div className="collect-pricing-title panel">
                    <h2 className="display-5 fw-bold text-dark dark:text-white mb-4">
                      Des tarifs adaptés à votre activité
                    </h2>
                  </div>
                  <div className="collect-pricing-description panel">
              ...
              <div className="collect-pricing-main panel">
                <div className="row g-4 lg:g-6 justify-content-center">
                  {collectPricingPlans.map((plan, index) => (
                    <div key={index} className="col-12 col-lg-4">
                      <div className={`collect-pricing-card panel h-100 p-6 lg:p-8 bg-white dark:bg-tertiary-700 rounded-3 border ${
                        plan.highlight 
                        ...
                        <div className="collect-pricing-card-header panel text-center mb-6">
                          ...
                          <div className="collect-pricing-commission panel">
                        ...
                        <div className="collect-pricing-card-features panel mb-6">
                        ...
                        <div className="collect-pricing-card-action panel">
                          <Link
              ...
              <div className="collect-pricing-footer panel">
                    ...
                    <div className="panel p-6 bg-light dark:bg-tertiary-600 rounded-3 text-center">
                      <div className="hstack gap-6 justify-content-center flex-wrap">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span className="fs-7 fw-semibold">Reversement rapide</span>
                        </div>
                        <div className="d-flex align-items-center gap-2">
                          <i className="icon icon-2 unicon-headphones text-info"></i>
                          <span className="fs-7 fw-semibold">Support local</span>
                        </div>
                      </div>
                    </div>
                  </div>
