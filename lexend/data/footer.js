...
export const footerLinks3 = [
  {
    title: "Industries",
    links: [
      { href: "/page-about", label: "Industries" },
      { href: "/page-about", label: "Information Technology" },
      { href: "/page-pricing", label: "Architecture" },
      { href: "/page-features", label: "Healthcare" },
      { href: "/page-integrations", label: "Insurance" },
      { href: "/page-career", label: "Virtual Assistant" },
      { href: "/page-contact", label: "Call Center" },
      { href: "/page-contact-2", label: "Data Entry" },
    ],
  },
  {
    title: "Features",
    links: [
      { href: "/shop", label: "Features" },
      { href: "/shop", label: "Time Tracking Software" },
      { href: "/shop-product-detail/2", label: "Employee Productivity Software" },
      { href: "/shop-product-detail-2/2", label: "Employee Monitoring Software" },
      { href: "/shop-cart", label: "Productivity Tracking Software" },
      { href: "/shop-checkout", label: "Desktop Monitoring Software" },
      { href: "/shop-order", label: "Remote Attendance Management" },
       { href: "/shop-order", label: "Telecalling Software" },
    ],
  },
  {
    title: "Learn More",
    links: [
      { href: "/sign-in", label: "Learn More" },
      { href: "/sign-in", label: "Desktop Activity Monitoring" },
      { href: "/sign-in-2", label: "Task Management Software" },
      { href: "/sign-up", label: "Improve Workforce Productivity" },
      { href: "/sign-up-2", label: "Remote Attendance" },
      { href: "/reset-password", label: "Attendance Management" },
      { href: "/reset-password-2", label: "Productivity Monitoring" },
      { href: "/reset-password-2", label: "Business Call Recording Software" },
    ],
  },
  {
    title: "Company",
    links: [
      { href: "/blog", label: "Company" },
      { href: "/blog-details/1", label: "Introduction" },
      { href: "/page-terms", label: "Partner" },
      { href: "/page-not-found", label: "Contact Us" },
    ],
  },
{
    title: "Compare",
    links: [
      { href: "/coming-soon", label: "Compare" },
      { href: "/coming-soon", label: "Activtrak" },
      { href: "/page-terms", label: "Desktime" },
      { href: "/page-privacy", label: "Time Doctor" },
    ],
  },
  {
    title: "Locations",
    links: [
      { href: "/coming-soon", label: "Locations" },
      { href: "/coming-soon", label: "TeamOB Solutions Pvt. Ltd." },
      { href: "/page-terms", label: "+91 9307907814" },
      { href: "/page-privacy", label: "+91 9307941903" },
    ],
  },
  {
    title: "Legal",
